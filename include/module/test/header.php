<? $cats=$this->db->fetch('SELECT * FROM article_cats ORDER BY id DESC');?><header id="header">
  <div class="wrapper">
    <a class="logo" href="test">Miga's journal</a>
    <nav id="topnav" class="navbar">
      <?php
        if (mysqli_num_rows($cats)==0) {
          echo '<a class="nav-link" href="test">Нийтлэлүүд</a>';
        }
        else
        {
...
<div class="sep">|</div>
      ...
      <a class="btn" href="test5"><?=$this->acc->name(true);?></a>
      ...
      <a class="btn" href="testadmin">admin</a><?php endif;?>
